            ...
            <>      
              ...
              <header className="z-index-fixed header-transparent header-absolute-top header-sticky">
                 ...
                 <div className="d-flex align-items-center navbar-no-collapse-items order-lg-last">
                              <button className="navbar-toggler order-last" type="button"
                                  data-bs-toggle="collapse" data-bs-target="#navbar-demo-4"
                                  aria-controls="navbar-demo-4" aria-expanded="false"
                              ...
                              <div className="nav-item me-3 me-lg-4">
                                  <a href="#!"
                                      className="btn btn-outline-secondary p-0 width-4x height-4x flex-center rounded-circle">
